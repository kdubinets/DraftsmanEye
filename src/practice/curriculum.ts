  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        id: "target",
        label: "Target",
        title: "Target drawing through 2 points",
        exerciseIds: ["target-line-two-points"],
      },
    ],
  },
  {
    id: "circle-ellipse-loops",
    title: "Circle / Ellipse / Loopy Figures",
    stages: [
      {
        id: "freehand",
        label: "Freehand",
        title: "Freehand circle, ellipse, and loops",
        exerciseIds: [
          "freehand-circle",
          "freehand-ellipse",
          "loop-chain-freehand",
      ...
      {
        id: "trace-loops-spirals",
        label: "Trace+",
        title: "Trace circle and ellipse plus guided loops and spirals",
        exerciseIds: [
          "trace-circle",
          "trace-ellipse",
          "loop-chain-linear",
